    ...
    <Col sm={12} md={6} lg={4} xl={3} className="">
        <Card className="">
          ...
          <Card.Body>
            ...
            magnam accusamus ipsam eius fugit natus placeat velit illo voluptas
            debitis magni, unde temporibus eveniet maxime beatae aut odio hic.
            Iusto.
          </Card.Body>
          <Card.Footer className="">
            <Button className="d-flex align-items-baseline" onClick={()=>Reveiew()}>
              Submit <span className="spinner-grow spinner-grow-sm"></span>
            </Button>
          </Card.Footer>
        </Card>
                </Col>
